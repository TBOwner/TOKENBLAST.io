					...
					<div wpfc-cdn-page="2" class="wiz-cont" style="display:none">
						...
						<div class="wiz-input-cont">
							<label class="mc-input-label" for="cdn-url" style="padding-right: 12px;">CDN Url:</label><select id="cdn-url">
																											    	 	<option value="http://i0.wp.com/localhost:8888">i0.wp.com</option>
																											    	 	<option value="http://i1.wp.com/localhost:8888">i1.wp.com</option>
																											    	 	<option value="http://i2.wp.com/localhost:8888">i2.wp.com</option>
																											    	 	<option value="http://i3.wp.com/localhost:8888">i3.wp.com</option>
					    ...
					    <div class="wiz-input-cont" style="display:none;">
							<label class="mc-input-label" for="origin-url">Origin Url:</label><input type="text" name="" value="localhost:8888" class="api-key" id="origin-url">
					    </div>
					</div>
